...
st.set_page_config(page_title="TANIKITA | Otentikasi", page_icon="🔑")
...
try:
    ...
    st.error("Gagal terhubung ke server. Silakan coba lagi nanti.")
    st.stop()
...
# Menggunakan Tabs untuk Login dan Register
...
with tab_login:
    ...
    if st.button("Masuk", type="primary"):
        ...
        if user_data and verify_password(login_password, user_data['password']):
            ...
            st.success("Berhasil masuk! Silakan buka menu Dasbor Petani di sebelah kiri.")
        else:
...
with tab_register:
    ...
    if st.button("Daftar Akun"):
        if reg_password != reg_confirm:
            ...
            # Tetapkan role 'admin' jika username adalah admin
            ...
            st.success("Pendaftaran berhasil! Silakan Masuk (Login) di tab sebelah.")
